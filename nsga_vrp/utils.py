...
def calculate_distance_matrix(customer1, customer2):
    ...
    api_key = 'AIzaSyCIVIQ80rPlRztD4Z41Fiq76BEfEyi80t4'  # Replace with your actual Google Maps API key
...
def convertcsv2json():
    ...
    customers = ['depart'] + [f'customer_{x}' for x in range(1, total_customer + 1)]
    # print(customers)
